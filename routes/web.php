...
Route::post('/comments/{comment}/like', 'CommentLikeController@store')->name('comments.like.store');
Route::delete('/comments/{comment}/like', 'CommentLikeController@destroy')->name('comments.like.destroy');
